...
bitcore-message-litecoinz adds support for verifying and signing litecoinz messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-litecoinz
```

```sh
bower install bitcore-message-litecoinz
```
...
var Message = require('bitcore-message-litecoinz');
